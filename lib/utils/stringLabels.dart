...
String truefalseKey ="truefalse";
String desTrueFalseKey="desTrueFalse";
...
String letsPlay = "letsplay";

String battleOfTheDayKey = "battleOfTheDay";
String selfExamZoneKey = "selfExamZone";
String playDifferentZoneKey = "playDifferentZone";
String guestMode="guestMode";
